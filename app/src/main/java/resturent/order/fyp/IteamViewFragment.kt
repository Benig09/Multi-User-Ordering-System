...
class IteamViewFragment : Fragment() {

    private var listener4: IteamDetilesViewFragment.FragmentDListener? = null
        ...
        view.ivProduct.setOnClickListener {
            ...
            if (arrPackage != null) {
                for (data in arrPackage) {
                    ...
                    Log.e("arrPackage",data.toString())
...
Log.e("vvv: ",productImage)
Log.e("fd",productPrice)
Log.e("fd",productName)
...
0
    ...
    private fun getProducts(): List<Product> {
        ...
        list.apply {
            addProduct { name = "11Orange juice"; img = R.drawable.juice4; price="7 RM";qua="1";category="false";waitingtime="9 Mint";description="It is a very clear liquid from which the pulp has been removed.."}
